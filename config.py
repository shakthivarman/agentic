...
class Config:
    ...
    MONGODB_DB_NAME = os.getenv("MONGODB_DB_NAME", "hcl")
    MONGODB_COLLECTION_NAME = os.getenv("MONGODB_COLLECTION_NAME", "hcl-web")
    VECTOR_INDEX_NAME = os.getenv("VECTOR_INDEX_NAME", "hcl_vector_index")
    ...
    def validate(cls) -> Dict[str, Any]:
        ...
        optional_configs = [
            ("MONGODB_DB_NAME", cls.MONGODB_DB_NAME, "hcl"),
            ("MONGODB_COLLECTION_NAME", cls.MONGODB_COLLECTION_NAME, "hcl-web"),
